...
Java_com_teckudos_letshearit_soundtouch_SoundTouch_getVersionString(JNIEnv *env, jclass clazz) {
    const char *verstr;
...
Java_com_teckudos_letshearit_soundtouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle,
                                                            jfloat tempo) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz,
                                                                     jlong handle,
                                                                     jfloat pitch) {
    SoundTouch *ptr = (SoundTouch *) handle;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle,
                                                            jfloat speed) {
    SoundTouch *ptr = (SoundTouch *) handle;
    ptr->setRate(speed);
}
...
Java_com_teckudos_letshearit_soundtouch_SoundTouch_processFile(JNIEnv *env, jobject thiz,
                                                               jlong handle,
                                                               jstring input_file,
                                                               jstring output_file) {
    SoundTouch *ptr = (SoundTouch *) handle;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_getErrorString(JNIEnv *env, jclass clazz) {
...
Java_com_teckudos_letshearit_soundtouch_SoundTouch_newInstance(JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz,
                                                                  jlong handle) {
    SoundTouch *ptr = (SoundTouch *) handle;
    delete ptr;
}extern "C"
JNIEXPORT void JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_setPitch(JNIEnv *env, jobject thiz, jlong handle,
                                                            jfloat pitch) {
    SoundTouch *ptr = (SoundTouch *) handle;
    ptr->setPitch(pitch);
}extern "C"
JNIEXPORT void JNICALL
Java_com_teckudos_letshearit_soundtouch_SoundTouch_setPitchOctaves(JNIEnv *env, jobject thiz,
                                                                   jlong handle,
                                                                   jfloat pitch) {
    SoundTouch *ptr = (SoundTouch *) handle;
